...
<table class="tbl-30">
                ...
                <tr>
                    <td>Description:</td>
                    <td><textarea name="description" cole="30" rows="5" placeholder="Description"></textarea></td>
                </tr>
                <tr>
                    <td>Price:</td>
...
if(isset($_POST['submit']))
{
    ...
    //check radio btn for feat and active checked or not
    ...
    if(isset($_FILES['image']['name']))
    {
        ...
        if($image_name!="")
        {
            ...
            if($upload==false)
            {
              ...
              header('loaction:'.HOMEURL.'admin/add-item.php');
              die();
            }
        }
    }
    ...
    {
        $_SESSION['add'] = "<div class='error'>Unsuccessful.</div>";
        header('location:'.HOMEURL.'admin/manage-item.php');
    }
