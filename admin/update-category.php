            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td><?php
                            ...
                            {
                                ?>
                                <img src="<?php echo HOMEURL; ?>images/category/<?php echo $current_image; ?>" width="125px">
                                <?php
                            }
                            else 
                            {
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(isset($_FILES['image']['name']))
        {
            ...
            if($image_name !="")
            {
                ...
                //B. remoce current image
                if($current_image!="")
                {
                $remove_path = "../images/category/".$current_image;
                $remove = unlink($remove_path);
                //check whether the image is removed or not
                //if failed to remove thend isl[play message and stop process
                if($remove==false)
                {
